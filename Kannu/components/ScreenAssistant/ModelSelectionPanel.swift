...
struct ModelSelectionView: View {
    ...
    private var isConfigurationValid: Bool {
        ...
        case .local:
            return SecurityURLPolicy.isAllowedModelEndpoint(localEndpoint)
        case .groq:
    ...
    private func loadCurrentConfiguration() {
        ...
        openaiApiKey = SecureSecretsStore.value(for: .openaiAPIKey)
        claudeApiKey = SecureSecretsStore.value(for: .claudeAPIKey)
        localEndpoint = Defaults[.localModelEndpoint]
        groqApiKey = SecureSecretsStore.value(for: .groqAPIKey)
    }
    ...
    private func saveConfiguration() {
        ...
        SecureSecretsStore.set(geminiApiKey, for: .geminiAPIKey)
        SecureSecretsStore.set(openaiApiKey, for: .openaiAPIKey)
        SecureSecretsStore.set(claudeApiKey, for: .claudeAPIKey)
        Defaults[.localModelEndpoint] = localEndpoint
        SecureSecretsStore.set(groqApiKey, for: .groqAPIKey)

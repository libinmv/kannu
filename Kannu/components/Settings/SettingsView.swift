...
struct SettingsView: View {
    ...
    private var settingsSearchIndex: [SettingsSearchEntry] {
        [
            ...
            SettingsSearchEntry(tab: .agentSecurity, title: "Policy rules", keywords: ["policy", "agent policy", "block", "ssh", "forbid", "deny", "command", "tool", "rules", "json", "edit", "editor", "modify"], highlightID: SettingsTab.agentSecurity.highlightID(for: "Policy rules")),

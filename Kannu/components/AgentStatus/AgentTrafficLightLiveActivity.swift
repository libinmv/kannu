...
struct AgentTrafficLightIndicator: View {
    ...
    private var showsSecurityGlyph: Bool {
        !suppressSecurityGlyph && highAlertMode.showsGlyph && findingsStore.groupRanking.pendingHighCount > 0
    }

...
final class TimerControlWindowManager {
    ...
    @discardableResult
    func present(using viewModel: KannuViewModel, metrics: TimerControlWindowMetrics) -> Bool {
    ...
    @discardableResult
    func refresh(using viewModel: KannuViewModel, metrics: TimerControlWindowMetrics) -> Bool {
    ...
    private func frame(for size: CGSize, viewModel: KannuViewModel, screen: NSScreen, metrics: TimerControlWindowMetrics) -> NSRect {

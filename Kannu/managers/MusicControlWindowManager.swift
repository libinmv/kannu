...
final class MusicControlWindowManager {
    ...
    @discardableResult
    func present(using viewModel: KannuViewModel, metrics: MusicControlWindowMetrics) -> Bool {
    ...
    @discardableResult
    func refresh(using viewModel: KannuViewModel, metrics: MusicControlWindowMetrics) -> Bool {
    ...
    private func resolveScreen(from viewModel: KannuViewModel) -> NSScreen? {
    ...
    private func frame(for size: CGSize, viewModel: KannuViewModel, screen: NSScreen, metrics: MusicControlWindowMetrics) -> NSRect {
